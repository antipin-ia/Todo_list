const tasks = [
  ...
  (function(arrOfTasks) {
    ...
    listContainer.addEventListener('click' ,onDeleteHeandler);
    ...
    function listItemTemlate({_id,title,body} = {}){
        ...
        const artecle = document.createElement('p');
        artecle.textContent = body;
        artecle.classList.add('mt-2','w-100');

        li.appendChild(span);
        li.appendChild(deleteBtn);
        li.appendChild(artecle);
